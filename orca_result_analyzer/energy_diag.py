...
class EnergyDiagramDialog(QDialog):
    ...
    def wheelEvent(self, event):
        ...
        if event.modifiers() & Qt.KeyboardModifier.ControlModifier:
            ...
            if angle_delta != 0:
                ...
                if new_span < 0.1: new_span = 0.1
                if new_span > 2000.0: new_span = 2000.0
    ...
    def try_load_cube(self, index, label, spin_suffix=""):
        ...
        if spin_suffix == "_A":
             ...
             patterns.append(f"*_MO_{target_idx}_*.cube") # For extended labels if any? No, safe_id is strict.
